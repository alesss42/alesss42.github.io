...
When the Kuroshio pushes warm, salty Pacific water into the fresher South China Sea, it doesn't mix quietly — it laminates. Layer by layer, contrasting water masses interleave like pages in a book, creating a staircase of temperature and salinity that defies standard mixing recipes. We followed these interleavings with gliders and microstructure profilers and found that where salt fingers and shear instability collude, turbulent mixing runs an order of magnitude hotter than models predict — and none of the usual parameterizations see it coming.
